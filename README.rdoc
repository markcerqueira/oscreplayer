...
Recording OSC messages:
   ...
   # data is written to the file every 2 seconds and/or when it is sent an interrupt (crtl+c)
   # send only one interrupt because if you do it twice you will interrupt the last flushing of data!
